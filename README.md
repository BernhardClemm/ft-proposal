...
## Country-level poll tracker re-design (Figure 1b)
...
The AP VoteCast can be downloaded [here](https://apnorc.org/projects/ap-votecast-2020-general-elections/). The script `code/us-voter-movements.R` summarizes the data and creates the Sankey plot below.
